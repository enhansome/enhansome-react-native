...
* [Expo Examples](https://github.com/expo/examples) ⭐ 3,716 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-17 - Example projects demonstrating Expo APIs and integrations.
...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 172,697 | 🐛 1,190 | 🌐 Python | 📅 2026-08-21 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,485 | 🐛 62 | 🌐 Shell | 📅 2026-08-28 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,254 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-30 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,152 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,508 | 🐛 1,697 | 🌐 TypeScript | 📅 2026-08-30 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,705 | 🐛 57 | 🌐 C++ | 📅 2026-08-30 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
...
* [llama.rn](https://github.com/mybigday/llama.rn) ⭐ 1,028 | 🐛 15 | 🌐 C++ | 📅 2026-08-28 - React Native binding of llama.cpp for running LLMs on device.
...
* [react-native-paper](https://github.com/callstack/react-native-paper) ⭐ 14,448 | 🐛 476 | 🌐 TypeScript | 📅 2026-08-28 - Material Design components for Android and iOS.
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,166 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-31 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [react-native-svg](https://github.com/software-mansion/react-native-svg) ⭐ 8,001 | 🐛 252 | 🌐 TypeScript | 📅 2026-08-20 - SVG rendering for React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,279 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-26 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-pager-view](https://github.com/callstack/react-native-pager-view) ⭐ 3,356 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-15 - Native ViewPager and UIPageViewController wrapper.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,187 | 🐛 186 | 🌐 TypeScript | 📅 2026-08-24 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [Legend List](https://github.com/LegendApp/legend-list) ⭐ 3,329 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-27 - High-performance list in pure JS, built for the New Architecture.
...
* [react-native-navigation](https://github.com/wix/react-native-navigation) ⭐ 13,175 | 🐛 50 | 🌐 MDX | 📅 2026-08-02 - Wix's fully native navigation solution.
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,721 | 🐛 282 | 🌐 TypeScript | 📅 2026-08-31 - Native navigation primitives that back React Navigation's native stack.
* [react-native-bottom-tabs](https://github.com/callstack/react-native-bottom-tabs) ⭐ 1,450 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-28 - Truly native bottom tab bars (SwiftUI and Material) for React Native.
...
* [react-native-bottom-sheet](https://github.com/gorhom/react-native-bottom-sheet) ⭐ 9,079 | 🐛 86 | 🌐 TypeScript | 📅 2026-05-09 - Performant, interactive bottom sheet with configurable gestures.
...
* [react-native-true-sheet](https://github.com/lodev09/react-native-true-sheet) ⭐ 2,046 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-26 - The true native bottom sheet experience.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,846 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-30 - Performant form state management and validation for React and React Native.
* [Formik](https://github.com/jaredpalmer/formik) ⭐ 34,327 | 🐛 839 | 🌐 TypeScript | 📅 2025-11-10 - Build forms without the tears.
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,706 | 🐛 123 | 🌐 TypeScript | 📅 2026-08-17 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,587 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-29 - Powerful, high-performance camera library with frame processors.
...
* [react-native-webrtc](https://github.com/react-native-webrtc/react-native-webrtc) ⭐ 4,990 | 🐛 32 | 🌐 Java | 📅 2026-08-10 - WebRTC for React Native.
...
* [react-native-audio-api](https://github.com/software-mansion/react-native-audio-api) ⭐ 833 | 🐛 32 | 🌐 C++ | 📅 2026-08-28 - High-performance audio engine implementing the Web Audio API.
* [expo-video](https://docs.expo.dev/versions/latest/sdk/video/) - Modern video playback built for Expo and the New Architecture.

### Maps & Location

* [react-native-maps](https://github.com/react-native-maps/react-native-maps) ⭐ 15,995 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-05 - MapView components for iOS and Android.
...
* [react-native-graph](https://github.com/margelo/react-native-graph) ⭐ 2,608 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-24 - Beautiful, high-performance line graphs built with Skia.
...
* [victory-native-xl](https://github.com/FormidableLabs/victory-native-xl) ⭐ 1,217 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-26 - Charting built on Skia and Reanimated with a focus on performance.

### Animation & Gestures

* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,972 | 🐛 324 | 🌐 TypeScript | 📅 2026-08-28 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,534 | 🐛 94 | 🌐 TypeScript | 📅 2026-08-31 - High-performance 2D graphics with the Skia rendering engine.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,138 | 🐛 248 | 🌐 TypeScript | 📅 2026-08-29 - Type-safe WebGPU toolkit for advanced GPU work.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,072 | 🐛 67 | 🌐 TypeScript | 📅 2026-07-17 - Tailwind CSS for React Native.
...
* [react-native-config](https://github.com/react-native-config/react-native-config) ⭐ 4,955 | 🐛 285 | 🌐 Ruby | 📅 2026-08-30 - Expose environment config to your JS and native code.
...
* [react-native-share](https://github.com/react-native-share/react-native-share) ⭐ 3,893 | 🐛 19 | 🌐 Java | 📅 2026-08-28 - Native share sheet and social sharing.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-31 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-web](https://github.com/necolas/react-native-web) ⭐ 22,141 | 🐛 168 | 🌐 JavaScript | 📅 2025-10-16 - Run React Native components and APIs on the web.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,333 | 🐛 797 | 🌐 C++ | 📅 2026-08-30 - Build native Windows apps with React.
* [react-native-macos](https://github.com/microsoft/react-native-macos) ⭐ 4,382 | 🐛 104 | 🌐 C++ | 📅 2026-08-17 - Build native macOS apps with React.

## Data

### State Management

* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,629 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-28 - Bear necessities for state management.
* [Jotai](https://github.com/pmndrs/jotai) ⭐ 21,250 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-24 - Primitive and flexible atomic state.
* [Redux Toolkit](https://github.com/reduxjs/redux-toolkit) ⭐ 11,225 | 🐛 313 | 🌐 TypeScript | 📅 2026-08-24 - The official, batteries-included Redux toolset.
...
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,636 | 🐛 2,001 | 🌐 TypeScript | 📅 2026-08-28 - TypeScript ORM with first-class Expo/React Native SQLite support.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,371 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-27 - Local-first, reactive database that replicates with your backend.
* [WatermelonDB](https://github.com/Nozbe/WatermelonDB) ⭐ 11,777 | 🐛 302 | 🌐 JavaScript | 📅 2025-08-11 - Reactive and asynchronous database for powerful apps that scale.
* [react-native-mmkv](https://github.com/mrousavy/react-native-mmkv) ⭐ 8,487 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-29 - The fastest key/value storage for React Native, \~30x faster than AsyncStorage.
* [Realm](https://github.com/realm/realm-js) ⭐ 6,003 | 🐛 658 | 🌐 TypeScript | 📅 2026-08-29 - Mobile object database, an alternative to SQLite.
* [AsyncStorage](https://github.com/react-native-async-storage/async-storage) ⭐ 5,071 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-31 - Simple, asynchronous, persistent key-value storage.
...
* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,236 | 🐛 137 | 🌐 TypeScript | 📅 2026-08-31 - Powerful async state management and data fetching.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-31 - Well-tested, feature-rich modular Firebase implementation.
...
* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,429 | 🐛 192 | 🌐 TypeScript | 📅 2026-08-28 - Official Stripe SDK for payments in React Native.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,349 | 🐛 456 | 🌐 TypeScript | 📅 2026-08-31 - Build, submit, and update iOS and Android apps from the command line.
...
* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,458 | 🐛 496 | 🌐 Kotlin | 📅 2026-08-28 - Painless declarative E2E automation for mobile.
* [Detox](https://github.com/wix/Detox) ⭐ 12,019 | 🐛 204 | 🌐 JavaScript | 📅 2026-08-24 - Gray-box end-to-end testing and automation framework.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,688 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-31 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,921 | 🐛 190 | 🌐 C++ | 📅 2026-08-29 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,174 | 🐛 621 | 🌐 TypeScript | 📅 2026-08-30 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,258 | 🐛 2,396 | 🌐 TypeScript | 📅 2026-08-28 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,016 | 🐛 2,162 | 🌐 TypeScript | 📅 2026-08-31 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,774 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - The art world in your pocket.
* [Mattermost](https://github.com/mattermost/mattermost-mobile) ⭐ 2,713 | 🐛 321 | 🌐 TypeScript | 📅 2026-08-31 - Mattermost's mobile apps.
* [Rocket.Chat](https://github.com/RocketChat/Rocket.Chat.ReactNative) ⭐ 2,413 | 🐛 478 | 🌐 TypeScript | 📅 2026-08-28 - Rocket.Chat's mobile client.
...
Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-react-native/graphs/contributors) ⭐ 35,693 | 🐛 13 | 📅 2026-08-26 :)
