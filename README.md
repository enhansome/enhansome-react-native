...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 176,025 | 🐛 1,227 | 🌐 Python | 📅 2026-09-10 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,521 | 🐛 67 | 🌐 Shell | 📅 2026-09-11 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,666 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-12 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,172 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,711 | 🐛 1,474 | 🌐 TypeScript | 📅 2026-09-12 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,732 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-11 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
...
* [llama.rn](https://github.com/mybigday/llama.rn) ⭐ 1,039 | 🐛 18 | 🌐 C++ | 📅 2026-09-12 - React Native binding of llama.cpp for running LLMs on device.
...
* [React Native Elements](https://github.com/react-native-elements/react-native-elements) ⭐ 25,862 | 🐛 156 | 🌐 MDX | 📅 2026-05-21 - Cross-platform UI toolkit with themed, composable components.
...
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,186 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-12 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [react-native-svg](https://github.com/software-mansion/react-native-svg) ⭐ 7,999 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-11 - SVG rendering for React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,300 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-02 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-blur](https://github.com/margelo/react-native-blur) ⭐ 3,878 | 🐛 249 | 🌐 TypeScript | 📅 2026-05-09 - Native blur view component.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,228 | 🐛 199 | 🌐 TypeScript | 📅 2026-09-07 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [React Navigation](https://github.com/react-navigation/react-navigation) ⭐ 24,499 | 🐛 846 | 🌐 TypeScript | 📅 2026-09-12 - The standard routing and navigation library for React Native.
...
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,728 | 🐛 292 | 🌐 TypeScript | 📅 2026-09-11 - Native navigation primitives that back React Navigation's native stack.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,854 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-12 - Performant form state management and validation for React and React Native.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,619 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-10 - Powerful, high-performance camera library with frame processors.
...
* [react-native-image-crop-picker](https://github.com/ivpusic/react-native-image-crop-picker) ⭐ 6,351 | 🐛 656 | 🌐 Objective-C | 📅 2026-01-21 - Image picker with camera, cropping, and compression.
...
* [react-native-video](https://github.com/TheWidlarzGroup/react-native-video) ⭐ 7,716 | 🐛 181 | 🌐 Kotlin | 📅 2026-09-12 - The Video component for React Native.
...
* [react-native-maps](https://github.com/react-native-maps/react-native-maps) ⭐ 15,997 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-10 - MapView components for iOS and Android.
...
* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,992 | 🐛 342 | 🌐 TypeScript | 📅 2026-09-12 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,578 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-12 - High-performance 2D graphics with the Skia rendering engine.
...
* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,102 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-11 - CSS-in-JS styling that also targets React Native.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,088 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-13 - Tailwind CSS for React Native.
...
* [Unistyles](https://github.com/jpudysz/react-native-unistyles) ⭐ 2,949 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-13 - C++-powered StyleSheet superset with themes and breakpoints, built for the New Architecture.
...
* [react-native-localize](https://github.com/zoontek/react-native-localize) ⭐ 2,441 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-13 - Toolbox for app localization: locales, timezones, currencies.

### System & Device

* [react-native-device-info](https://github.com/react-native-device-info/react-native-device-info) ⭐ 6,678 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-12 - Device information for iOS and Android.
...
* [react-native-contacts](https://github.com/morenoh149/react-native-contacts) ⭐ 1,704 | 🐛 7 | 🌐 Java | 📅 2026-09-10 - Native contacts access.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,305 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-11 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-webview](https://github.com/react-native-webview/react-native-webview) ⭐ 7,192 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-12 - The community WebView component.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,342 | 🐛 806 | 🌐 C++ | 📅 2026-09-11 - Build native Windows apps with React.
* [react-native-macos](https://github.com/microsoft/react-native-macos) ⭐ 4,384 | 🐛 117 | 🌐 C++ | 📅 2026-09-10 - Build native macOS apps with React.

## Data

### State Management

* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,674 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-11 - Bear necessities for state management.
* [Jotai](https://github.com/pmndrs/jotai) ⭐ 21,264 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 - Primitive and flexible atomic state.
...
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,753 | 🐛 2,022 | 🌐 TypeScript | 📅 2026-09-11 - TypeScript ORM with first-class Expo/React Native SQLite support.
...
* [op-sqlite](https://github.com/OP-Engineering/op-sqlite) ⭐ 1,034 | 🐛 7 | 🌐 C | 📅 2026-09-07 - The fastest SQLite library for React Native.
* [expo-sqlite](https://docs.expo.dev/versions/latest/sdk/sqlite/) - SQLite database access in Expo, with support for Drizzle ORM.

### Networking

* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,283 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-13 - Powerful async state management and data fetching.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,305 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-11 - Well-tested, feature-rich modular Firebase implementation.
...
* [sentry-react-native](https://github.com/getsentry/sentry-react-native) ⭐ 1,823 | 🐛 122 | 🌐 TypeScript | 📅 2026-09-11 - Official Sentry SDK for crash reporting and performance monitoring.

## Payments & Monetization

* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,428 | 🐛 216 | 🌐 TypeScript | 📅 2026-09-11 - Official Stripe SDK for payments in React Native.
...
* [Re.Pack](https://github.com/callstack/repack) ⭐ 1,931 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-12 - Webpack/Rspack-based toolkit with code splitting and Module Federation for React Native.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,353 | 🐛 471 | 🌐 TypeScript | 📅 2026-09-12 - Build, submit, and update iOS and Android apps from the command line.
...
* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,602 | 🐛 513 | 🌐 Kotlin | 📅 2026-09-13 - Painless declarative E2E automation for mobile.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,710 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-13 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,934 | 🐛 202 | 🌐 C++ | 📅 2026-09-10 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,344 | 🐛 640 | 🌐 TypeScript | 📅 2026-09-13 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,288 | 🐛 2,405 | 🌐 TypeScript | 📅 2026-09-11 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,023 | 🐛 2,281 | 🌐 TypeScript | 📅 2026-09-13 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,773 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-13 - The art world in your pocket.
* [Mattermost](https://github.com/mattermost/mattermost-mobile) ⭐ 2,721 | 🐛 327 | 🌐 TypeScript | 📅 2026-09-12 - Mattermost's mobile apps.
