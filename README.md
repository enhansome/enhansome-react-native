...
* [Upgrade Helper](https://github.com/react-native-community/upgrade-helper) ⭐ 4,065 | 🐛 17 | 🌐 TypeScript | 📅 2026-07-23 - Web tool that shows the exact diff between two React Native versions for painless upgrades.
* [Expo Examples](https://github.com/expo/examples) ⭐ 3,718 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-17 - Example projects demonstrating Expo APIs and integrations.
...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 173,060 | 🐛 1,199 | 🌐 Python | 📅 2026-09-01 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,494 | 🐛 63 | 🌐 Shell | 📅 2026-09-01 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,302 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-01 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,156 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,532 | 🐛 1,568 | 🌐 TypeScript | 📅 2026-09-02 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,706 | 🐛 53 | 🌐 C++ | 📅 2026-09-02 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
...
* [llama.rn](https://github.com/mybigday/llama.rn) ⭐ 1,032 | 🐛 15 | 🌐 C++ | 📅 2026-08-28 - React Native binding of llama.cpp for running LLMs on device.
...
* [React Native Elements](https://github.com/react-native-elements/react-native-elements) ⭐ 25,858 | 🐛 156 | 🌐 MDX | 📅 2026-05-21 - Cross-platform UI toolkit with themed, composable components.
* [NativeBase](https://github.com/GeekyAnts/NativeBase) ⭐ 20,381 | 🐛 376 | 🌐 TypeScript | 📅 2026-01-31 - Mobile-first, accessible component library for React Native and web.
* [react-native-vector-icons](https://github.com/oblador/react-native-vector-icons) ⭐ 17,916 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-30 - Customizable icon sets with support for styling and image sources.
* [lottie-react-native](https://github.com/lottie-react-native/lottie-react-native) ⭐ 17,211 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-22 - Render After Effects animations natively.
* [react-native-paper](https://github.com/callstack/react-native-paper) ⭐ 14,451 | 🐛 480 | 🌐 TypeScript | 📅 2026-09-01 - Material Design components for Android and iOS.
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,169 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-02 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [react-native-svg](https://github.com/software-mansion/react-native-svg) ⭐ 8,002 | 🐛 255 | 🌐 TypeScript | 📅 2026-09-01 - SVG rendering for React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,280 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-26 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-pager-view](https://github.com/callstack/react-native-pager-view) ⭐ 3,356 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-01 - Native ViewPager and UIPageViewController wrapper.
...
* [react-native-blurhash](https://github.com/mrousavy/react-native-blurhash) ⭐ 2,237 | 🐛 32 | 🌐 Kotlin | 📅 2026-03-19 - Colorful blurry placeholders while content loads.
...
* [react-native-country-picker-modal](https://github.com/xcarpentier/react-native-country-picker-modal) ⭐ 1,112 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-01 - Country picker with flags, search, and localization.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,194 | 🐛 188 | 🌐 TypeScript | 📅 2026-08-31 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [Legend List](https://github.com/LegendApp/legend-list) ⭐ 3,333 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-01 - High-performance list in pure JS, built for the New Architecture.

### Navigation

* [React Navigation](https://github.com/react-navigation/react-navigation) ⭐ 24,502 | 🐛 843 | 🌐 TypeScript | 📅 2026-08-26 - The standard routing and navigation library for React Native.
* [react-native-navigation](https://github.com/wix/react-native-navigation) ⭐ 13,176 | 🐛 59 | 🌐 MDX | 📅 2026-08-02 - Wix's fully native navigation solution.
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,725 | 🐛 270 | 🌐 TypeScript | 📅 2026-09-02 - Native navigation primitives that back React Navigation's native stack.
...
* [react-native-bottom-sheet](https://github.com/gorhom/react-native-bottom-sheet) ⭐ 9,081 | 🐛 85 | 🌐 TypeScript | 📅 2026-05-09 - Performant, interactive bottom sheet with configurable gestures.
...
* [react-native-true-sheet](https://github.com/lodev09/react-native-true-sheet) ⭐ 2,046 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-01 - The true native bottom sheet experience.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,843 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-31 - Performant form state management and validation for React and React Native.
* [Formik](https://github.com/jaredpalmer/formik) ⭐ 34,329 | 🐛 840 | 🌐 TypeScript | 📅 2025-11-10 - Build forms without the tears.
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,707 | 🐛 122 | 🌐 TypeScript | 📅 2026-08-17 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-autocomplete-input](https://github.com/byteburgers/react-native-autocomplete-input) ⭐ 871 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-31 - Pure JavaScript autocomplete input.
...
* [react-native-live-markdown](https://github.com/Expensify/react-native-live-markdown) ⭐ 1,337 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-24 - Drop-in TextInput replacement with live Markdown formatting, by Expensify.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,593 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-31 - Powerful, high-performance camera library with frame processors.
* [react-native-image-picker](https://github.com/react-native-image-picker/react-native-image-picker) ⭐ 8,634 | 🐛 347 | 🌐 Java | 📅 2026-03-17 - Native UI for selecting photos and videos.
* [react-native-image-crop-picker](https://github.com/ivpusic/react-native-image-crop-picker) ⭐ 6,350 | 🐛 654 | 🌐 Objective-C | 📅 2026-01-21 - Image picker with camera, cropping, and compression.
...
* [react-native-video](https://github.com/TheWidlarzGroup/react-native-video) ⭐ 7,715 | 🐛 176 | 🌐 Kotlin | 📅 2026-09-01 - The Video component for React Native.
* [react-native-webrtc](https://github.com/react-native-webrtc/react-native-webrtc) ⭐ 4,991 | 🐛 32 | 🌐 Java | 📅 2026-08-10 - WebRTC for React Native.
...
* [react-native-audio-api](https://github.com/software-mansion/react-native-audio-api) ⭐ 835 | 🐛 36 | 🌐 C++ | 📅 2026-09-01 - High-performance audio engine implementing the Web Audio API.
* [expo-video](https://docs.expo.dev/versions/latest/sdk/video/) - Modern video playback built for Expo and the New Architecture.

### Maps & Location

* [react-native-maps](https://github.com/react-native-maps/react-native-maps) ⭐ 15,994 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-01 - MapView components for iOS and Android.
* [react-native-background-geolocation](https://github.com/transistorsoft/react-native-background-geolocation) ⭐ 2,920 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-30 - Battery-conscious background location with motion detection.
* [rnmapbox/maps](https://github.com/rnmapbox/maps) ⭐ 2,908 | 🐛 159 | 🌐 Kotlin | 📅 2026-07-22 - Mapbox maps for custom map experiences.
...
* [react-native-map-link](https://github.com/tschoffelen/react-native-map-link) ⭐ 821 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-01 - Open the user's preferred maps app.

### Charts

* [react-native-graph](https://github.com/margelo/react-native-graph) ⭐ 2,611 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-24 - Beautiful, high-performance line graphs built with Skia.
...
* [victory-native-xl](https://github.com/FormidableLabs/victory-native-xl) ⭐ 1,218 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-31 - Charting built on Skia and Reanimated with a focus on performance.

### Animation & Gestures

* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,974 | 🐛 325 | 🌐 TypeScript | 📅 2026-09-01 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,539 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-01 - High-performance 2D graphics with the Skia rendering engine.
* [react-native-gesture-handler](https://github.com/software-mansion/react-native-gesture-handler) ⭐ 6,782 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-27 - Declarative, native-driven gesture system.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,156 | 🐛 254 | 🌐 TypeScript | 📅 2026-09-02 - Type-safe WebGPU toolkit for advanced GPU work.

### Styling & Design Systems

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,121 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-28 - CSS-in-JS styling that also targets React Native.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,076 | 🐛 67 | 🌐 TypeScript | 📅 2026-07-17 - Tailwind CSS for React Native.
...
* [Unistyles](https://github.com/jpudysz/react-native-unistyles) ⭐ 2,937 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-13 - C++-powered StyleSheet superset with themes and breakpoints, built for the New Architecture.
* [react-native-safe-area-context](https://github.com/AppAndFlow/react-native-safe-area-context) ⭐ 2,755 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-01 - Flexible safe area inset handling.
...
* [react-native-device-info](https://github.com/react-native-device-info/react-native-device-info) ⭐ 6,680 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-31 - Device information for iOS and Android.
...
* [react-native-permissions](https://github.com/zoontek/react-native-permissions) ⭐ 4,379 | 🐛 7 | 🌐 Objective-C++ | 📅 2026-07-23 - Unified permissions API.
* [react-native-share](https://github.com/react-native-share/react-native-share) ⭐ 3,893 | 🐛 17 | 🌐 Java | 📅 2026-08-31 - Native share sheet and social sharing.
* [react-native-keychain](https://github.com/oblador/react-native-keychain) ⭐ 3,475 | 🐛 189 | 🌐 Kotlin | 📅 2026-04-29 - Secure keychain and keystore access.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-02 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-onesignal](https://github.com/OneSignal/react-native-onesignal) ⭐ 1,592 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-02 - OneSignal push notification SDK.
* [Expo Notifications](https://docs.expo.dev/versions/latest/sdk/notifications/) - Push and local notifications for Expo apps.

### Web & WebViews

* [react-native-web](https://github.com/necolas/react-native-web) ⭐ 22,142 | 🐛 166 | 🌐 JavaScript | 📅 2025-10-16 - Run React Native components and APIs on the web.
...
* [Solito](https://github.com/nandorojo/solito) ⭐ 4,089 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-31 - React Native + Next.js, unified navigation for universal apps.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,336 | 🐛 796 | 🌐 C++ | 📅 2026-09-02 - Build native Windows apps with React.
* [react-native-macos](https://github.com/microsoft/react-native-macos) ⭐ 4,384 | 🐛 104 | 🌐 C++ | 📅 2026-09-01 - Build native macOS apps with React.

## Data

### State Management

* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,636 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-31 - Bear necessities for state management.
* [Jotai](https://github.com/pmndrs/jotai) ⭐ 21,248 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-24 - Primitive and flexible atomic state.
* [Redux Toolkit](https://github.com/reduxjs/redux-toolkit) ⭐ 11,224 | 🐛 314 | 🌐 TypeScript | 📅 2026-09-01 - The official, batteries-included Redux toolset.
* [Legend State](https://github.com/LegendApp/legend-state) ⭐ 4,194 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-11 - Super fast state with fine-grained reactivity and built-in sync.

### Storage & Databases

* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,653 | 🐛 2,001 | 🌐 TypeScript | 📅 2026-09-01 - TypeScript ORM with first-class Expo/React Native SQLite support.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,372 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-02 - Local-first, reactive database that replicates with your backend.
* [WatermelonDB](https://github.com/Nozbe/WatermelonDB) ⭐ 11,779 | 🐛 302 | 🌐 JavaScript | 📅 2025-08-11 - Reactive and asynchronous database for powerful apps that scale.
* [react-native-mmkv](https://github.com/mrousavy/react-native-mmkv) ⭐ 8,490 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-29 - The fastest key/value storage for React Native, \~30x faster than AsyncStorage.
* [Realm](https://github.com/realm/realm-js) ⭐ 6,004 | 🐛 658 | 🌐 TypeScript | 📅 2026-08-29 - Mobile object database, an alternative to SQLite.
* [AsyncStorage](https://github.com/react-native-async-storage/async-storage) ⭐ 5,071 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-31 - Simple, asynchronous, persistent key-value storage.
...
* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,246 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-02 - Powerful async state management and data fetching.
...
* [react-native-quick-crypto](https://github.com/margelo/react-native-quick-crypto) ⭐ 1,067 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-15 - Fast native implementation of Node's crypto module.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-02 - Well-tested, feature-rich modular Firebase implementation.
* [google-signin](https://github.com/react-native-google-signin/google-signin) ⭐ 3,553 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-01 - Google Sign-In for React Native.
...
* [sentry-react-native](https://github.com/getsentry/sentry-react-native) ⭐ 1,820 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-01 - Official Sentry SDK for crash reporting and performance monitoring.

## Payments & Monetization

* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,429 | 🐛 192 | 🌐 TypeScript | 📅 2026-09-01 - Official Stripe SDK for payments in React Native.
* [react-native-purchases](https://github.com/RevenueCat/react-native-purchases) ⭐ 1,204 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-01 - RevenueCat SDK for in-app purchases and subscriptions.
...
* [Radon IDE](https://github.com/software-mansion/radon-ide) ⭐ 1,717 | 🐛 145 | 🌐 TypeScript | 📅 2026-08-26 - VSCode/Cursor extension that turns your editor into a full-featured React Native IDE with an embedded simulator.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,348 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-02 - Build, submit, and update iOS and Android apps from the command line.

### Debugging

* [Reactotron](https://github.com/infinitered/reactotron) ⭐ 15,588 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-13 - Desktop app for inspecting React Native apps: state, API requests, performance.
* [Buoy](https://github.com/Buoy-gg/buoy) ⭐ 690 | 🐛 4 | 📅 2026-09-01 - Devtools that live in your app — and answer to your AI agent.

### Testing

* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,480 | 🐛 497 | 🌐 Kotlin | 📅 2026-09-01 - Painless declarative E2E automation for mobile.
* [Detox](https://github.com/wix/Detox) ⭐ 12,022 | 🐛 204 | 🌐 JavaScript | 📅 2026-08-24 - Gray-box end-to-end testing and automation framework.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,693 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-02 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,922 | 🐛 180 | 🌐 C++ | 📅 2026-09-01 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,197 | 🐛 633 | 🌐 TypeScript | 📅 2026-09-01 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,261 | 🐛 2,392 | 🌐 TypeScript | 📅 2026-09-02 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,016 | 🐛 2,170 | 🌐 TypeScript | 📅 2026-09-02 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,773 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-02 - The art world in your pocket.
* [Mattermost](https://github.com/mattermost/mattermost-mobile) ⭐ 2,713 | 🐛 327 | 🌐 TypeScript | 📅 2026-09-01 - Mattermost's mobile apps.
* [Rocket.Chat](https://github.com/RocketChat/Rocket.Chat.ReactNative) ⭐ 2,413 | 🐛 483 | 🌐 TypeScript | 📅 2026-09-01 - Rocket.Chat's mobile client.
...
Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-react-native/graphs/contributors) ⭐ 35,691 | 🐛 14 | 📅 2026-08-26 :)
