...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 175,882 | 🐛 1,226 | 🌐 Python | 📅 2026-09-10 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,520 | 🐛 67 | 🌐 Shell | 📅 2026-09-11 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,657 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-11 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,171 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,699 | 🐛 1,468 | 🌐 TypeScript | 📅 2026-09-12 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,731 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-11 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
...
* [llama.rn](https://github.com/mybigday/llama.rn) ⭐ 1,037 | 🐛 19 | 🌐 C++ | 📅 2026-09-12 - React Native binding of llama.cpp for running LLMs on device.
...
* [NativeBase](https://github.com/GeekyAnts/NativeBase) ⭐ 20,375 | 🐛 376 | 🌐 TypeScript | 📅 2026-01-31 - Mobile-first, accessible component library for React Native and web.
...
* [lottie-react-native](https://github.com/lottie-react-native/lottie-react-native) ⭐ 17,209 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-10 - Render After Effects animations natively.
* [react-native-paper](https://github.com/callstack/react-native-paper) ⭐ 14,461 | 🐛 489 | 🌐 TypeScript | 📅 2026-09-11 - Material Design components for Android and iOS.
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,185 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-12 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,298 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-02 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,226 | 🐛 199 | 🌐 TypeScript | 📅 2026-09-07 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [Legend List](https://github.com/LegendApp/legend-list) ⭐ 3,362 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-11 - High-performance list in pure JS, built for the New Architecture.

### Navigation

* [React Navigation](https://github.com/react-navigation/react-navigation) ⭐ 24,500 | 🐛 847 | 🌐 TypeScript | 📅 2026-09-12 - The standard routing and navigation library for React Native.
* [react-native-navigation](https://github.com/wix/react-native-navigation) ⭐ 13,177 | 🐛 61 | 🌐 MDX | 📅 2026-09-09 - Wix's fully native navigation solution.
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,727 | 🐛 290 | 🌐 TypeScript | 📅 2026-09-11 - Native navigation primitives that back React Navigation's native stack.
* [react-native-bottom-tabs](https://github.com/callstack/react-native-bottom-tabs) ⭐ 1,451 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-10 - Truly native bottom tab bars (SwiftUI and Material) for React Native.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,853 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-11 - Performant form state management and validation for React and React Native.
* [Formik](https://github.com/jaredpalmer/formik) ⭐ 34,318 | 🐛 841 | 🌐 TypeScript | 📅 2025-11-10 - Build forms without the tears.
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,720 | 🐛 122 | 🌐 TypeScript | 📅 2026-09-11 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,616 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-10 - Powerful, high-performance camera library with frame processors.
...
* [react-native-video](https://github.com/TheWidlarzGroup/react-native-video) ⭐ 7,717 | 🐛 183 | 🌐 Kotlin | 📅 2026-09-11 - The Video component for React Native.
...
* [react-native-maps](https://github.com/react-native-maps/react-native-maps) ⭐ 15,998 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-10 - MapView components for iOS and Android.
...
* [rnmapbox/maps](https://github.com/rnmapbox/maps) ⭐ 2,909 | 🐛 164 | 🌐 Kotlin | 📅 2026-07-22 - Mapbox maps for custom map experiences.
...
* [react-native-gifted-charts](https://github.com/Abhinandan-Kushwaha/react-native-gifted-charts) ⭐ 1,366 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-09 - Bar, line, area, pie, donut, and stacked charts.
...
* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,992 | 🐛 341 | 🌐 TypeScript | 📅 2026-09-12 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,575 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-11 - High-performance 2D graphics with the Skia rendering engine.
* [react-native-gesture-handler](https://github.com/software-mansion/react-native-gesture-handler) ⭐ 6,781 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-11 - Declarative, native-driven gesture system.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,087 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-12 - Tailwind CSS for React Native.
...
* [Unistyles](https://github.com/jpudysz/react-native-unistyles) ⭐ 2,948 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-13 - C++-powered StyleSheet superset with themes and breakpoints, built for the New Architecture.
...
* [document-picker](https://github.com/react-native-documents/document-picker) ⭐ 1,515 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-11 - Document picker and viewer.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,303 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-11 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-webview](https://github.com/react-native-webview/react-native-webview) ⭐ 7,192 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-11 - The community WebView component.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,341 | 🐛 805 | 🌐 C++ | 📅 2026-09-11 - Build native Windows apps with React.
...
* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,669 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-11 - Bear necessities for state management.
...
* [Legend State](https://github.com/LegendApp/legend-state) ⭐ 4,193 | 🐛 218 | 🌐 TypeScript | 📅 2026-08-11 - Super fast state with fine-grained reactivity and built-in sync.

### Storage & Databases

* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,745 | 🐛 2,019 | 🌐 TypeScript | 📅 2026-09-11 - TypeScript ORM with first-class Expo/React Native SQLite support.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,377 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-12 - Local-first, reactive database that replicates with your backend.
...
* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,280 | 🐛 179 | 🌐 TypeScript | 📅 2026-09-12 - Powerful async state management and data fetching.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,303 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-11 - Well-tested, feature-rich modular Firebase implementation.
...
* [sentry-react-native](https://github.com/getsentry/sentry-react-native) ⭐ 1,823 | 🐛 121 | 🌐 TypeScript | 📅 2026-09-11 - Official Sentry SDK for crash reporting and performance monitoring.

## Payments & Monetization

* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,428 | 🐛 215 | 🌐 TypeScript | 📅 2026-09-11 - Official Stripe SDK for payments in React Native.
* [react-native-purchases](https://github.com/RevenueCat/react-native-purchases) ⭐ 1,210 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-11 - RevenueCat SDK for in-app purchases and subscriptions.
...
* [Re.Pack](https://github.com/callstack/repack) ⭐ 1,932 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-11 - Webpack/Rspack-based toolkit with code splitting and Module Federation for React Native.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,353 | 🐛 470 | 🌐 TypeScript | 📅 2026-09-12 - Build, submit, and update iOS and Android apps from the command line.
...
* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,594 | 🐛 513 | 🌐 Kotlin | 📅 2026-09-11 - Painless declarative E2E automation for mobile.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,710 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-12 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Ignite](https://github.com/infinitered/ignite) ⭐ 19,940 | 🐛 36 | 🌐 TypeScript | 📅 2026-06-07 - Infinite Red's battle-tested boilerplate with CLI and generators.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,335 | 🐛 632 | 🌐 TypeScript | 📅 2026-09-11 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,285 | 🐛 2,405 | 🌐 TypeScript | 📅 2026-09-11 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,022 | 🐛 2,269 | 🌐 TypeScript | 📅 2026-09-12 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,773 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-12 - The art world in your pocket.
* [Mattermost](https://github.com/mattermost/mattermost-mobile) ⭐ 2,720 | 🐛 327 | 🌐 TypeScript | 📅 2026-09-12 - Mattermost's mobile apps.
* [Rocket.Chat](https://github.com/RocketChat/Rocket.Chat.ReactNative) ⭐ 2,412 | 🐛 478 | 🌐 TypeScript | 📅 2026-09-11 - Rocket.Chat's mobile client.
...
Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-react-native/graphs/contributors) ⭐ 35,697 | 🐛 20 | 📅 2026-08-26 :)
