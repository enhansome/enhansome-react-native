...
* [Expo Examples](https://github.com/expo/examples) ⭐ 3,717 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-17 - Example projects demonstrating Expo APIs and integrations.
...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 172,854 | 🐛 1,195 | 🌐 Python | 📅 2026-08-21 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,487 | 🐛 59 | 🌐 Shell | 📅 2026-08-31 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,271 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-31 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,154 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,517 | 🐛 1,705 | 🌐 TypeScript | 📅 2026-09-01 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,706 | 🐛 56 | 🌐 C++ | 📅 2026-08-31 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
* [react-native-fast-tflite](https://github.com/mrousavy/react-native-fast-tflite) ⭐ 1,232 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-28 - High-performance TensorFlow Lite inference with GPU acceleration.
* [llama.rn](https://github.com/mybigday/llama.rn) ⭐ 1,030 | 🐛 15 | 🌐 C++ | 📅 2026-08-28 - React Native binding of llama.cpp for running LLMs on device.
...
* [NativeBase](https://github.com/GeekyAnts/NativeBase) ⭐ 20,382 | 🐛 376 | 🌐 TypeScript | 📅 2026-01-31 - Mobile-first, accessible component library for React Native and web.
* [react-native-vector-icons](https://github.com/oblador/react-native-vector-icons) ⭐ 17,914 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-30 - Customizable icon sets with support for styling and image sources.
* [lottie-react-native](https://github.com/lottie-react-native/lottie-react-native) ⭐ 17,210 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-22 - Render After Effects animations natively.
* [react-native-paper](https://github.com/callstack/react-native-paper) ⭐ 14,449 | 🐛 476 | 🌐 TypeScript | 📅 2026-08-28 - Material Design components for Android and iOS.
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,166 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-01 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [react-native-svg](https://github.com/software-mansion/react-native-svg) ⭐ 8,001 | 🐛 254 | 🌐 TypeScript | 📅 2026-08-20 - SVG rendering for React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,281 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-26 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-reanimated-carousel](https://github.com/dohooo/react-native-reanimated-carousel) ⭐ 3,430 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-08 - Swiper/carousel built entirely on Reanimated, the successor to snap-carousel.
* [react-native-pager-view](https://github.com/callstack/react-native-pager-view) ⭐ 3,356 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-31 - Native ViewPager and UIPageViewController wrapper.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,189 | 🐛 188 | 🌐 TypeScript | 📅 2026-08-31 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [Legend List](https://github.com/LegendApp/legend-list) ⭐ 3,332 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-27 - High-performance list in pure JS, built for the New Architecture.
...
* [react-native-navigation](https://github.com/wix/react-native-navigation) ⭐ 13,175 | 🐛 59 | 🌐 MDX | 📅 2026-08-02 - Wix's fully native navigation solution.
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,724 | 🐛 273 | 🌐 TypeScript | 📅 2026-08-31 - Native navigation primitives that back React Navigation's native stack.
...
* [react-native-bottom-sheet](https://github.com/gorhom/react-native-bottom-sheet) ⭐ 9,081 | 🐛 87 | 🌐 TypeScript | 📅 2026-05-09 - Performant, interactive bottom sheet with configurable gestures.
...
* [react-native-true-sheet](https://github.com/lodev09/react-native-true-sheet) ⭐ 2,046 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-31 - The true native bottom sheet experience.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,841 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-31 - Performant form state management and validation for React and React Native.
* [Formik](https://github.com/jaredpalmer/formik) ⭐ 34,329 | 🐛 839 | 🌐 TypeScript | 📅 2025-11-10 - Build forms without the tears.
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,707 | 🐛 121 | 🌐 TypeScript | 📅 2026-08-17 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,589 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-31 - Powerful, high-performance camera library with frame processors.
...
* [react-native-video](https://github.com/TheWidlarzGroup/react-native-video) ⭐ 7,715 | 🐛 176 | 🌐 Kotlin | 📅 2026-08-14 - The Video component for React Native.
...
* [react-native-track-player](https://github.com/doublesymmetry/react-native-track-player) ⭐ 3,708 | 🐛 16 | 🌐 TypeScript | 📅 2026-07-31 - Full-featured audio player: background playback, Android Auto, CarPlay, lock-screen controls.
* [react-native-sound](https://github.com/zmxv/react-native-sound) ⭐ 2,918 | 🐛 253 | 🌐 TypeScript | 📅 2026-02-12 - Play sound clips natively.
* [react-native-audio-api](https://github.com/software-mansion/react-native-audio-api) ⭐ 833 | 🐛 33 | 🌐 C++ | 📅 2026-08-31 - High-performance audio engine implementing the Web Audio API.
* [expo-video](https://docs.expo.dev/versions/latest/sdk/video/) - Modern video playback built for Expo and the New Architecture.

### Maps & Location

* [react-native-maps](https://github.com/react-native-maps/react-native-maps) ⭐ 15,995 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-05 - MapView components for iOS and Android.
* [react-native-background-geolocation](https://github.com/transistorsoft/react-native-background-geolocation) ⭐ 2,920 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-30 - Battery-conscious background location with motion detection.
* [rnmapbox/maps](https://github.com/rnmapbox/maps) ⭐ 2,906 | 🐛 158 | 🌐 Kotlin | 📅 2026-07-22 - Mapbox maps for custom map experiences.
...
* [react-native-graph](https://github.com/margelo/react-native-graph) ⭐ 2,609 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-24 - Beautiful, high-performance line graphs built with Skia.
...
* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,973 | 🐛 325 | 🌐 TypeScript | 📅 2026-08-31 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,535 | 🐛 94 | 🌐 TypeScript | 📅 2026-08-31 - High-performance 2D graphics with the Skia rendering engine.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,144 | 🐛 251 | 🌐 TypeScript | 📅 2026-08-31 - Type-safe WebGPU toolkit for advanced GPU work.

### Styling & Design Systems

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,126 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-28 - CSS-in-JS styling that also targets React Native.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,073 | 🐛 67 | 🌐 TypeScript | 📅 2026-07-17 - Tailwind CSS for React Native.
...
* [react-native-safe-area-context](https://github.com/AppAndFlow/react-native-safe-area-context) ⭐ 2,754 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-31 - Flexible safe area inset handling.
...
* [react-native-keychain](https://github.com/oblador/react-native-keychain) ⭐ 3,474 | 🐛 189 | 🌐 Kotlin | 📅 2026-04-29 - Secure keychain and keystore access.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-01 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-onesignal](https://github.com/OneSignal/react-native-onesignal) ⭐ 1,592 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-01 - OneSignal push notification SDK.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,335 | 🐛 798 | 🌐 C++ | 📅 2026-09-01 - Build native Windows apps with React.
* [react-native-macos](https://github.com/microsoft/react-native-macos) ⭐ 4,383 | 🐛 104 | 🌐 C++ | 📅 2026-08-17 - Build native macOS apps with React.

## Data

### State Management

* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,628 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-31 - Bear necessities for state management.
* [Jotai](https://github.com/pmndrs/jotai) ⭐ 21,249 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-24 - Primitive and flexible atomic state.
* [Redux Toolkit](https://github.com/reduxjs/redux-toolkit) ⭐ 11,225 | 🐛 315 | 🌐 TypeScript | 📅 2026-08-24 - The official, batteries-included Redux toolset.
* [Legend State](https://github.com/LegendApp/legend-state) ⭐ 4,195 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-11 - Super fast state with fine-grained reactivity and built-in sync.

### Storage & Databases

* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,646 | 🐛 2,004 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript ORM with first-class Expo/React Native SQLite support.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,371 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-31 - Local-first, reactive database that replicates with your backend.
* [WatermelonDB](https://github.com/Nozbe/WatermelonDB) ⭐ 11,778 | 🐛 302 | 🌐 JavaScript | 📅 2025-08-11 - Reactive and asynchronous database for powerful apps that scale.
* [react-native-mmkv](https://github.com/mrousavy/react-native-mmkv) ⭐ 8,489 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-29 - The fastest key/value storage for React Native, \~30x faster than AsyncStorage.
...
* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,239 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-01 - Powerful async state management and data fetching.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-01 - Well-tested, feature-rich modular Firebase implementation.
* [google-signin](https://github.com/react-native-google-signin/google-signin) ⭐ 3,552 | 🐛 24 | 🌐 TypeScript | 📅 2026-07-27 - Google Sign-In for React Native.
* [react-native-app-auth](https://github.com/FormidableLabs/react-native-app-auth) ⭐ 2,254 | 🐛 157 | 🌐 Java | 📅 2026-07-06 - PKCE-compliant OAuth2 client based on AppAuth.
* [sentry-react-native](https://github.com/getsentry/sentry-react-native) ⭐ 1,819 | 🐛 132 | 🌐 TypeScript | 📅 2026-09-01 - Official Sentry SDK for crash reporting and performance monitoring.

## Payments & Monetization

* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,429 | 🐛 192 | 🌐 TypeScript | 📅 2026-08-31 - Official Stripe SDK for payments in React Native.
* [react-native-purchases](https://github.com/RevenueCat/react-native-purchases) ⭐ 1,204 | 🐛 77 | 🌐 TypeScript | 📅 2026-08-31 - RevenueCat SDK for in-app purchases and subscriptions.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,348 | 🐛 455 | 🌐 TypeScript | 📅 2026-09-01 - Build, submit, and update iOS and Android apps from the command line.
...
* [Buoy](https://github.com/Buoy-gg/buoy) ⭐ 690 | 🐛 4 | 📅 2026-08-29 - Devtools that live in your app — and answer to your AI agent.

### Testing

* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,465 | 🐛 498 | 🌐 Kotlin | 📅 2026-08-31 - Painless declarative E2E automation for mobile.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,690 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-01 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,921 | 🐛 185 | 🌐 C++ | 📅 2026-08-31 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,180 | 🐛 626 | 🌐 TypeScript | 📅 2026-09-01 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,257 | 🐛 2,392 | 🌐 TypeScript | 📅 2026-09-01 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,017 | 🐛 2,157 | 🌐 TypeScript | 📅 2026-09-01 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,773 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-01 - The art world in your pocket.
* [Mattermost](https://github.com/mattermost/mattermost-mobile) ⭐ 2,713 | 🐛 320 | 🌐 TypeScript | 📅 2026-08-31 - Mattermost's mobile apps.
* [Rocket.Chat](https://github.com/RocketChat/Rocket.Chat.ReactNative) ⭐ 2,413 | 🐛 482 | 🌐 TypeScript | 📅 2026-08-31 - Rocket.Chat's mobile client.
...
Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-react-native/graphs/contributors) ⭐ 35,695 | 🐛 13 | 📅 2026-08-26 :)
