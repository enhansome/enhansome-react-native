...
* [Expo Examples](https://github.com/expo/examples) ⭐ 3,719 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-17 - Example projects demonstrating Expo APIs and integrations.
...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 173,311 | 🐛 1,204 | 🌐 Python | 📅 2026-09-01 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,496 | 🐛 61 | 🌐 Shell | 📅 2026-09-02 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,316 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-01 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,159 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,557 | 🐛 1,543 | 🌐 TypeScript | 📅 2026-09-03 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,709 | 🐛 53 | 🌐 C++ | 📅 2026-09-02 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
...
* [react-native-paper](https://github.com/callstack/react-native-paper) ⭐ 14,453 | 🐛 483 | 🌐 TypeScript | 📅 2026-09-02 - Material Design components for Android and iOS.
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,172 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-03 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,280 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-02 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-country-picker-modal](https://github.com/xcarpentier/react-native-country-picker-modal) ⭐ 1,112 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-02 - Country picker with flags, search, and localization.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,195 | 🐛 189 | 🌐 TypeScript | 📅 2026-08-31 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [Legend List](https://github.com/LegendApp/legend-list) ⭐ 3,335 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-01 - High-performance list in pure JS, built for the New Architecture.
...
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,725 | 🐛 280 | 🌐 TypeScript | 📅 2026-09-02 - Native navigation primitives that back React Navigation's native stack.
* [react-native-bottom-tabs](https://github.com/callstack/react-native-bottom-tabs) ⭐ 1,449 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-03 - Truly native bottom tab bars (SwiftUI and Material) for React Native.
...
* [Zeego](https://github.com/nandorojo/zeego) ⭐ 2,253 | 🐛 48 | 🌐 TypeScript | 📅 2026-01-28 - Menus for React Native done right — truly native dropdown and context menus.
...
* [react-native-true-sheet](https://github.com/lodev09/react-native-true-sheet) ⭐ 2,049 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - The true native bottom sheet experience.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,846 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-03 - Performant form state management and validation for React and React Native.
* [Formik](https://github.com/jaredpalmer/formik) ⭐ 34,328 | 🐛 840 | 🌐 TypeScript | 📅 2025-11-10 - Build forms without the tears.
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,708 | 🐛 126 | 🌐 TypeScript | 📅 2026-09-02 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-live-markdown](https://github.com/Expensify/react-native-live-markdown) ⭐ 1,337 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-02 - Drop-in TextInput replacement with live Markdown formatting, by Expensify.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,602 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-31 - Powerful, high-performance camera library with frame processors.
...
* [react-native-video](https://github.com/TheWidlarzGroup/react-native-video) ⭐ 7,715 | 🐛 178 | 🌐 Kotlin | 📅 2026-09-01 - The Video component for React Native.
* [react-native-webrtc](https://github.com/react-native-webrtc/react-native-webrtc) ⭐ 4,991 | 🐛 35 | 🌐 Java | 📅 2026-09-03 - WebRTC for React Native.
...
* [react-native-audio-api](https://github.com/software-mansion/react-native-audio-api) ⭐ 835 | 🐛 40 | 🌐 C++ | 📅 2026-09-02 - High-performance audio engine implementing the Web Audio API.
...
* [victory-native-xl](https://github.com/FormidableLabs/victory-native-xl) ⭐ 1,219 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-31 - Charting built on Skia and Reanimated with a focus on performance.

### Animation & Gestures

* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,974 | 🐛 324 | 🌐 TypeScript | 📅 2026-09-02 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,540 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-02 - High-performance 2D graphics with the Skia rendering engine.
* [react-native-gesture-handler](https://github.com/software-mansion/react-native-gesture-handler) ⭐ 6,781 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-02 - Declarative, native-driven gesture system.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,159 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-02 - Type-safe WebGPU toolkit for advanced GPU work.

### Styling & Design Systems

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,124 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-28 - CSS-in-JS styling that also targets React Native.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,077 | 🐛 68 | 🌐 TypeScript | 📅 2026-07-17 - Tailwind CSS for React Native.
...
* [Unistyles](https://github.com/jpudysz/react-native-unistyles) ⭐ 2,938 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-13 - C++-powered StyleSheet superset with themes and breakpoints, built for the New Architecture.
* [react-native-safe-area-context](https://github.com/AppAndFlow/react-native-safe-area-context) ⭐ 2,756 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-01 - Flexible safe area inset handling.
...
* [react-native-localize](https://github.com/zoontek/react-native-localize) ⭐ 2,442 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-12 - Toolbox for app localization: locales, timezones, currencies.
...
* [document-picker](https://github.com/react-native-documents/document-picker) ⭐ 1,516 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-02 - Document picker and viewer.
...
* [react-native-sensors](https://github.com/react-native-sensors/react-native-sensors) ⭐ 934 | 🐛 48 | 🌐 Objective-C | 📅 2026-09-02 - Developer-friendly access to device sensors.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-03 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-onesignal](https://github.com/OneSignal/react-native-onesignal) ⭐ 1,592 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-03 - OneSignal push notification SDK.
...
* [Solito](https://github.com/nandorojo/solito) ⭐ 4,090 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-31 - React Native + Next.js, unified navigation for universal apps.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,338 | 🐛 802 | 🌐 C++ | 📅 2026-09-02 - Build native Windows apps with React.
* [react-native-macos](https://github.com/microsoft/react-native-macos) ⭐ 4,384 | 🐛 106 | 🌐 C++ | 📅 2026-09-02 - Build native macOS apps with React.

## Data

### State Management

* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,638 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-31 - Bear necessities for state management.
...
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,663 | 🐛 2,003 | 🌐 TypeScript | 📅 2026-09-01 - TypeScript ORM with first-class Expo/React Native SQLite support.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,372 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-03 - Local-first, reactive database that replicates with your backend.
...
* [react-native-mmkv](https://github.com/mrousavy/react-native-mmkv) ⭐ 8,493 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-03 - The fastest key/value storage for React Native, \~30x faster than AsyncStorage.
* [Realm](https://github.com/realm/realm-js) ⭐ 6,004 | 🐛 658 | 🌐 TypeScript | 📅 2026-08-29 - Mobile object database, an alternative to SQLite.
* [AsyncStorage](https://github.com/react-native-async-storage/async-storage) ⭐ 5,071 | 🐛 25 | 🌐 Kotlin | 📅 2026-09-02 - Simple, asynchronous, persistent key-value storage.
...
* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,252 | 🐛 150 | 🌐 TypeScript | 📅 2026-09-03 - Powerful async state management and data fetching.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-03 - Well-tested, feature-rich modular Firebase implementation.
* [google-signin](https://github.com/react-native-google-signin/google-signin) ⭐ 3,553 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-01 - Google Sign-In for React Native.
* [react-native-app-auth](https://github.com/FormidableLabs/react-native-app-auth) ⭐ 2,255 | 🐛 156 | 🌐 Java | 📅 2026-07-06 - PKCE-compliant OAuth2 client based on AppAuth.
* [sentry-react-native](https://github.com/getsentry/sentry-react-native) ⭐ 1,820 | 🐛 133 | 🌐 TypeScript | 📅 2026-09-02 - Official Sentry SDK for crash reporting and performance monitoring.

## Payments & Monetization

* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,429 | 🐛 192 | 🌐 TypeScript | 📅 2026-09-02 - Official Stripe SDK for payments in React Native.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,350 | 🐛 451 | 🌐 TypeScript | 📅 2026-09-02 - Build, submit, and update iOS and Android apps from the command line.
...
* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,490 | 🐛 499 | 🌐 Kotlin | 📅 2026-09-02 - Painless declarative E2E automation for mobile.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,693 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-03 - Self-hostable OTA update solution, a CodePush alternative.
...
* [create-react-native-library](https://github.com/callstack/react-native-builder-bob) ⭐ 3,225 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-04 - Scaffold and build React Native libraries for distribution.
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,924 | 🐛 181 | 🌐 C++ | 📅 2026-09-01 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,215 | 🐛 645 | 🌐 TypeScript | 📅 2026-09-03 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,261 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-09-03 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,016 | 🐛 2,232 | 🌐 TypeScript | 📅 2026-09-03 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,773 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-03 - The art world in your pocket.
* [Mattermost](https://github.com/mattermost/mattermost-mobile) ⭐ 2,714 | 🐛 325 | 🌐 TypeScript | 📅 2026-09-03 - Mattermost's mobile apps.
* [Rocket.Chat](https://github.com/RocketChat/Rocket.Chat.ReactNative) ⭐ 2,413 | 🐛 482 | 🌐 TypeScript | 📅 2026-09-02 - Rocket.Chat's mobile client.
