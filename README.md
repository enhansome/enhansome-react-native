...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 178,404 | 🐛 1,310 | 🌐 Python | 📅 2026-09-24 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,612 | 🐛 71 | 🌐 Shell | 📅 2026-09-24 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 7,028 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-23 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,182 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,958 | 🐛 1,441 | 🌐 TypeScript | 📅 2026-09-26 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,747 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-25 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
...
* [llama.rn](https://github.com/mybigday/llama.rn) ⭐ 1,041 | 🐛 19 | 🌐 C | 📅 2026-09-26 - React Native binding of llama.cpp for running LLMs on device.
...
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,207 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-26 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,319 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-02 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-pager-view](https://github.com/callstack/react-native-pager-view) ⭐ 3,364 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-25 - Native ViewPager and UIPageViewController wrapper.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,238 | 🐛 202 | 🌐 TypeScript | 📅 2026-09-15 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [React Navigation](https://github.com/react-navigation/react-navigation) ⭐ 24,508 | 🐛 853 | 🌐 TypeScript | 📅 2026-09-22 - The standard routing and navigation library for React Native.
...
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,732 | 🐛 330 | 🌐 TypeScript | 📅 2026-09-25 - Native navigation primitives that back React Navigation's native stack.
...
* [react-native-bottom-sheet](https://github.com/gorhom/react-native-bottom-sheet) ⭐ 9,103 | 🐛 77 | 🌐 TypeScript | 📅 2026-05-09 - Performant, interactive bottom sheet with configurable gestures.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,865 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-26 - Performant form state management and validation for React and React Native.
* [Formik](https://github.com/jaredpalmer/formik) ⭐ 34,320 | 🐛 842 | 🌐 TypeScript | 📅 2025-11-10 - Build forms without the tears.
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,738 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-24 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-autocomplete-input](https://github.com/byteburgers/react-native-autocomplete-input) ⭐ 871 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-21 - Pure JavaScript autocomplete input.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,637 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-14 - Powerful, high-performance camera library with frame processors.
...
* [react-native-video](https://github.com/TheWidlarzGroup/react-native-video) ⭐ 7,718 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-26 - The Video component for React Native.
...
* [react-native-audio-api](https://github.com/software-mansion/react-native-audio-api) ⭐ 842 | 🐛 46 | 🌐 C++ | 📅 2026-09-25 - High-performance audio engine implementing the Web Audio API.
...
* [react-native-background-geolocation](https://github.com/transistorsoft/react-native-background-geolocation) ⭐ 2,930 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-25 - Battery-conscious background location with motion detection.
* [rnmapbox/maps](https://github.com/rnmapbox/maps) ⭐ 2,916 | 🐛 159 | 🌐 Kotlin | 📅 2026-09-21 - Mapbox maps for custom map experiences.
...
* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 11,010 | 🐛 352 | 🌐 TypeScript | 📅 2026-09-25 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,611 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-24 - High-performance 2D graphics with the Skia rendering engine.
* [react-native-gesture-handler](https://github.com/software-mansion/react-native-gesture-handler) ⭐ 6,789 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-25 - Declarative, native-driven gesture system.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,235 | 🐛 288 | 🌐 TypeScript | 📅 2026-09-25 - Type-safe WebGPU toolkit for advanced GPU work.

### Styling & Design Systems

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,101 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-25 - CSS-in-JS styling that also targets React Native.
...
* [Unistyles](https://github.com/jpudysz/react-native-unistyles) ⭐ 2,958 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-13 - C++-powered StyleSheet superset with themes and breakpoints, built for the New Architecture.
* [react-native-safe-area-context](https://github.com/AppAndFlow/react-native-safe-area-context) ⭐ 2,760 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-16 - Flexible safe area inset handling.
...
* [react-native-device-info](https://github.com/react-native-device-info/react-native-device-info) ⭐ 6,681 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-26 - Device information for iOS and Android.
...
* [react-native-share](https://github.com/react-native-share/react-native-share) ⭐ 3,895 | 🐛 12 | 🌐 Java | 📅 2026-08-31 - Native share sheet and social sharing.
...
* [expo-quick-actions](https://github.com/EvanBacon/expo-quick-actions) ⭐ 661 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-25 - Home screen quick actions and custom app icons.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,311 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-25 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-web](https://github.com/necolas/react-native-web) ⭐ 22,137 | 🐛 149 | 🌐 JavaScript | 📅 2026-09-25 - Run React Native components and APIs on the web.
...
* [Solito](https://github.com/nandorojo/solito) ⭐ 4,095 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-10 - React Native + Next.js, unified navigation for universal apps.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,348 | 🐛 806 | 🌐 C++ | 📅 2026-09-25 - Build native Windows apps with React.
* [react-native-macos](https://github.com/microsoft/react-native-macos) ⭐ 4,386 | 🐛 113 | 🌐 C++ | 📅 2026-09-26 - Build native macOS apps with React.

## Data

### State Management

* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,750 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22 - Bear necessities for state management.
* [Jotai](https://github.com/pmndrs/jotai) ⭐ 21,281 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-17 - Primitive and flexible atomic state.
* [Redux Toolkit](https://github.com/reduxjs/redux-toolkit) ⭐ 11,225 | 🐛 278 | 🌐 TypeScript | 📅 2026-09-24 - The official, batteries-included Redux toolset.
* [Legend State](https://github.com/LegendApp/legend-state) ⭐ 4,213 | 🐛 219 | 🌐 TypeScript | 📅 2026-08-11 - Super fast state with fine-grained reactivity and built-in sync.

### Storage & Databases

* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,901 | 🐛 2,070 | 🌐 TypeScript | 📅 2026-09-25 - TypeScript ORM with first-class Expo/React Native SQLite support.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,390 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-26 - Local-first, reactive database that replicates with your backend.
...
* [op-sqlite](https://github.com/OP-Engineering/op-sqlite) ⭐ 1,043 | 🐛 8 | 🌐 C | 📅 2026-09-20 - The fastest SQLite library for React Native.
* [expo-sqlite](https://docs.expo.dev/versions/latest/sdk/sqlite/) - SQLite database access in Expo, with support for Drizzle ORM.

### Networking

* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,360 | 🐛 166 | 🌐 TypeScript | 📅 2026-09-26 - Powerful async state management and data fetching.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,311 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-25 - Well-tested, feature-rich modular Firebase implementation.
...
* [sentry-react-native](https://github.com/getsentry/sentry-react-native) ⭐ 1,823 | 🐛 125 | 🌐 TypeScript | 📅 2026-09-26 - Official Sentry SDK for crash reporting and performance monitoring.

## Payments & Monetization

* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,430 | 🐛 215 | 🌐 TypeScript | 📅 2026-09-25 - Official Stripe SDK for payments in React Native.
* [react-native-purchases](https://github.com/RevenueCat/react-native-purchases) ⭐ 1,213 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-25 - RevenueCat SDK for in-app purchases and subscriptions.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,359 | 🐛 489 | 🌐 TypeScript | 📅 2026-09-25 - Build, submit, and update iOS and Android apps from the command line.
...
* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,799 | 🐛 532 | 🌐 Kotlin | 📅 2026-09-25 - Painless declarative E2E automation for mobile.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,743 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-24 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,953 | 🐛 212 | 🌐 C++ | 📅 2026-09-25 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.

## Starters & Boilerplates

* [Ignite](https://github.com/infinitered/ignite) ⭐ 19,943 | 🐛 38 | 🌐 TypeScript | 📅 2026-06-07 - Infinite Red's battle-tested boilerplate with CLI and generators.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,481 | 🐛 634 | 🌐 TypeScript | 📅 2026-09-26 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,301 | 🐛 2,420 | 🌐 TypeScript | 📅 2026-09-26 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,032 | 🐛 2,382 | 🌐 TypeScript | 📅 2026-09-26 - New Expensify: financial collaboration, chat-centered.
...
* [Rocket.Chat](https://github.com/RocketChat/Rocket.Chat.ReactNative) ⭐ 2,414 | 🐛 490 | 🌐 TypeScript | 📅 2026-09-25 - Rocket.Chat's mobile client.
...
Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-react-native/graphs/contributors) ⭐ 35,708 | 🐛 23 | 📅 2026-08-26 :)
