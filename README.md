...
* [Expo Examples](https://github.com/expo/examples) ⭐ 3,714 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-17 - Example projects demonstrating Expo APIs and integrations.
...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 172,187 | 🐛 1,181 | 🌐 Python | 📅 2026-08-21 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,472 | 🐛 61 | 🌐 Shell | 📅 2026-08-27 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,052 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-26 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,148 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,465 | 🐛 1,697 | 🌐 TypeScript | 📅 2026-08-28 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
...
* [llama.rn](https://github.com/mybigday/llama.rn) ⭐ 1,026 | 🐛 15 | 🌐 C++ | 📅 2026-08-28 - React Native binding of llama.cpp for running LLMs on device.
...
* [React Native Elements](https://github.com/react-native-elements/react-native-elements) ⭐ 25,866 | 🐛 156 | 🌐 MDX | 📅 2026-05-21 - Cross-platform UI toolkit with themed, composable components.
...
* [lottie-react-native](https://github.com/lottie-react-native/lottie-react-native) ⭐ 17,207 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-22 - Render After Effects animations natively.
* [react-native-paper](https://github.com/callstack/react-native-paper) ⭐ 14,448 | 🐛 473 | 🌐 TypeScript | 📅 2026-08-27 - Material Design components for Android and iOS.
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,158 | 🐛 106 | 🌐 TypeScript | 📅 2026-08-28 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,271 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-26 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-pager-view](https://github.com/callstack/react-native-pager-view) ⭐ 3,353 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-15 - Native ViewPager and UIPageViewController wrapper.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,184 | 🐛 186 | 🌐 TypeScript | 📅 2026-08-24 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [Legend List](https://github.com/LegendApp/legend-list) ⭐ 3,326 | 🐛 77 | 🌐 TypeScript | 📅 2026-08-27 - High-performance list in pure JS, built for the New Architecture.

### Navigation

* [React Navigation](https://github.com/react-navigation/react-navigation) ⭐ 24,501 | 🐛 842 | 🌐 TypeScript | 📅 2026-08-26 - The standard routing and navigation library for React Native.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,842 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-28 - Performant form state management and validation for React and React Native.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,582 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-26 - Powerful, high-performance camera library with frame processors.
...
* [react-native-video](https://github.com/TheWidlarzGroup/react-native-video) ⭐ 7,714 | 🐛 148 | 🌐 Kotlin | 📅 2026-08-14 - The Video component for React Native.
...
* [react-native-track-player](https://github.com/doublesymmetry/react-native-track-player) ⭐ 3,707 | 🐛 15 | 🌐 TypeScript | 📅 2026-07-31 - Full-featured audio player: background playback, Android Auto, CarPlay, lock-screen controls.
...
* [victory-native-xl](https://github.com/FormidableLabs/victory-native-xl) ⭐ 1,215 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-26 - Charting built on Skia and Reanimated with a focus on performance.

### Animation & Gestures

* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,969 | 🐛 323 | 🌐 TypeScript | 📅 2026-08-28 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,531 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-23 - High-performance 2D graphics with the Skia rendering engine.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,121 | 🐛 245 | 🌐 TypeScript | 📅 2026-08-28 - Type-safe WebGPU toolkit for advanced GPU work.

### Styling & Design Systems

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,127 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-17 - CSS-in-JS styling that also targets React Native.
* [Emotion](https://github.com/emotion-js/emotion) ⭐ 18,019 | 🐛 392 | 🌐 JavaScript | 📅 2026-08-28 - High-performance CSS-in-JS style composition.
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,065 | 🐛 65 | 🌐 TypeScript | 📅 2026-07-17 - Tailwind CSS for React Native.
...
* [react-native-safe-area-context](https://github.com/AppAndFlow/react-native-safe-area-context) ⭐ 2,753 | 🐛 119 | 🌐 TypeScript | 📅 2026-08-27 - Flexible safe area inset handling.
...
* [react-native-config](https://github.com/react-native-config/react-native-config) ⭐ 4,955 | 🐛 287 | 🌐 Ruby | 📅 2026-08-27 - Expose environment config to your JS and native code.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-28 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-onesignal](https://github.com/OneSignal/react-native-onesignal) ⭐ 1,593 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-28 - OneSignal push notification SDK.
...
* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,625 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-24 - Bear necessities for state management.
* [Jotai](https://github.com/pmndrs/jotai) ⭐ 21,246 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-24 - Primitive and flexible atomic state.
* [Redux Toolkit](https://github.com/reduxjs/redux-toolkit) ⭐ 11,225 | 🐛 291 | 🌐 TypeScript | 📅 2026-08-24 - The official, batteries-included Redux toolset.
...
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,614 | 🐛 1,989 | 🌐 TypeScript | 📅 2026-08-28 - TypeScript ORM with first-class Expo/React Native SQLite support.
...
* [react-native-mmkv](https://github.com/mrousavy/react-native-mmkv) ⭐ 8,484 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-23 - The fastest key/value storage for React Native, \~30x faster than AsyncStorage.
...
* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,223 | 🐛 133 | 🌐 TypeScript | 📅 2026-08-28 - Powerful async state management and data fetching.
...
* [react-native-quick-crypto](https://github.com/margelo/react-native-quick-crypto) ⭐ 1,065 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-15 - Fast native implementation of Node's crypto module.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,301 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-28 - Well-tested, feature-rich modular Firebase implementation.
...
* [sentry-react-native](https://github.com/getsentry/sentry-react-native) ⭐ 1,819 | 🐛 129 | 🌐 TypeScript | 📅 2026-08-28 - Official Sentry SDK for crash reporting and performance monitoring.
...
* [Re.Pack](https://github.com/callstack/repack) ⭐ 1,932 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-22 - Webpack/Rspack-based toolkit with code splitting and Module Federation for React Native.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,348 | 🐛 461 | 🌐 TypeScript | 📅 2026-08-28 - Build, submit, and update iOS and Android apps from the command line.
...
* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,444 | 🐛 496 | 🌐 Kotlin | 📅 2026-08-28 - Painless declarative E2E automation for mobile.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,683 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-28 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,914 | 🐛 156 | 🌐 C++ | 📅 2026-08-27 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,134 | 🐛 621 | 🌐 TypeScript | 📅 2026-08-28 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,244 | 🐛 2,379 | 🌐 TypeScript | 📅 2026-08-28 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,014 | 🐛 2,155 | 🌐 TypeScript | 📅 2026-08-28 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,775 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-28 - The art world in your pocket.
...
Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-react-native/graphs/contributors) ⭐ 35,694 | 🐛 8 | 📅 2026-08-26 :)
