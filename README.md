...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 174,216 | 🐛 1,208 | 🌐 Python | 📅 2026-09-03 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,501 | 🐛 61 | 🌐 Shell | 📅 2026-09-03 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,334 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-04 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,163 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,582 | 🐛 1,491 | 🌐 TypeScript | 📅 2026-09-05 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,712 | 🐛 50 | 🌐 C++ | 📅 2026-09-04 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
...
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,177 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-04 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,285 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-02 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-pager-view](https://github.com/callstack/react-native-pager-view) ⭐ 3,356 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-04 - Native ViewPager and UIPageViewController wrapper.
...
* [Legend List](https://github.com/LegendApp/legend-list) ⭐ 3,342 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-01 - High-performance list in pure JS, built for the New Architecture.

### Navigation

* [React Navigation](https://github.com/react-navigation/react-navigation) ⭐ 24,503 | 🐛 844 | 🌐 TypeScript | 📅 2026-08-26 - The standard routing and navigation library for React Native.
...
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,725 | 🐛 283 | 🌐 TypeScript | 📅 2026-09-04 - Native navigation primitives that back React Navigation's native stack.
* [react-native-bottom-tabs](https://github.com/callstack/react-native-bottom-tabs) ⭐ 1,450 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-05 - Truly native bottom tab bars (SwiftUI and Material) for React Native.
...
* [react-native-true-sheet](https://github.com/lodev09/react-native-true-sheet) ⭐ 2,050 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04 - The true native bottom sheet experience.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,850 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-04 - Performant form state management and validation for React and React Native.
* [Formik](https://github.com/jaredpalmer/formik) ⭐ 34,328 | 🐛 840 | 🌐 TypeScript | 📅 2025-11-10 - Build forms without the tears.
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,714 | 🐛 126 | 🌐 TypeScript | 📅 2026-09-04 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,611 | 🐛 76 | 🌐 TypeScript | 📅 2026-08-31 - Powerful, high-performance camera library with frame processors.
...
* [react-native-audio-api](https://github.com/software-mansion/react-native-audio-api) ⭐ 836 | 🐛 39 | 🌐 C++ | 📅 2026-09-04 - High-performance audio engine implementing the Web Audio API.
* [expo-video](https://docs.expo.dev/versions/latest/sdk/video/) - Modern video playback built for Expo and the New Architecture.

### Maps & Location

* [react-native-maps](https://github.com/react-native-maps/react-native-maps) ⭐ 15,996 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-03 - MapView components for iOS and Android.
* [react-native-background-geolocation](https://github.com/transistorsoft/react-native-background-geolocation) ⭐ 2,922 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-30 - Battery-conscious background location with motion detection.
* [rnmapbox/maps](https://github.com/rnmapbox/maps) ⭐ 2,908 | 🐛 160 | 🌐 Kotlin | 📅 2026-07-22 - Mapbox maps for custom map experiences.
...
* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,977 | 🐛 321 | 🌐 TypeScript | 📅 2026-09-04 - The standard for performant animations, running on the UI thread.
* [react-native-animatable](https://github.com/oblador/react-native-animatable) ⭐ 9,933 | 🐛 172 | 🌐 JavaScript | 📅 2023-10-26 - Declarative transitions and standard animations.
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,542 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-03 - High-performance 2D graphics with the Skia rendering engine.
* [react-native-gesture-handler](https://github.com/software-mansion/react-native-gesture-handler) ⭐ 6,783 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-04 - Declarative, native-driven gesture system.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,164 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-04 - Type-safe WebGPU toolkit for advanced GPU work.

### Styling & Design Systems

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,122 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-05 - CSS-in-JS styling that also targets React Native.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,081 | 🐛 68 | 🌐 TypeScript | 📅 2026-07-17 - Tailwind CSS for React Native.
...
* [react-native-safe-area-context](https://github.com/AppAndFlow/react-native-safe-area-context) ⭐ 2,755 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-05 - Flexible safe area inset handling.
...
* [react-native-config](https://github.com/react-native-config/react-native-config) ⭐ 4,956 | 🐛 296 | 🌐 Ruby | 📅 2026-08-30 - Expose environment config to your JS and native code.
...
* [react-native-background-downloader](https://github.com/kesha-antonov/react-native-background-downloader) ⭐ 215 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-06 - Download and upload large files, even when the app is backgrounded.

### Notifications

* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-05 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,338 | 🐛 802 | 🌐 C++ | 📅 2026-09-05 - Build native Windows apps with React.
* [react-native-macos](https://github.com/microsoft/react-native-macos) ⭐ 4,383 | 🐛 108 | 🌐 C++ | 📅 2026-09-04 - Build native macOS apps with React.

## Data

### State Management

* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,644 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-31 - Bear necessities for state management.
* [Jotai](https://github.com/pmndrs/jotai) ⭐ 21,251 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-04 - Primitive and flexible atomic state.
* [Redux Toolkit](https://github.com/reduxjs/redux-toolkit) ⭐ 11,223 | 🐛 304 | 🌐 TypeScript | 📅 2026-09-05 - The official, batteries-included Redux toolset.
...
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,681 | 🐛 2,001 | 🌐 TypeScript | 📅 2026-09-04 - TypeScript ORM with first-class Expo/React Native SQLite support.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,373 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-04 - Local-first, reactive database that replicates with your backend.
...
* [react-native-mmkv](https://github.com/mrousavy/react-native-mmkv) ⭐ 8,495 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-03 - The fastest key/value storage for React Native, \~30x faster than AsyncStorage.
...
* [op-sqlite](https://github.com/OP-Engineering/op-sqlite) ⭐ 1,031 | 🐛 7 | 🌐 C | 📅 2026-08-21 - The fastest SQLite library for React Native.
* [expo-sqlite](https://docs.expo.dev/versions/latest/sdk/sqlite/) - SQLite database access in Expo, with support for Drizzle ORM.

### Networking

* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,268 | 🐛 161 | 🌐 TypeScript | 📅 2026-09-05 - Powerful async state management and data fetching.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-05 - Well-tested, feature-rich modular Firebase implementation.
...
* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,428 | 🐛 202 | 🌐 TypeScript | 📅 2026-09-04 - Official Stripe SDK for payments in React Native.
* [react-native-purchases](https://github.com/RevenueCat/react-native-purchases) ⭐ 1,207 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-04 - RevenueCat SDK for in-app purchases and subscriptions.
...
* [Re.Pack](https://github.com/callstack/repack) ⭐ 1,932 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-31 - Webpack/Rspack-based toolkit with code splitting and Module Federation for React Native.
...
* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,509 | 🐛 504 | 🌐 Kotlin | 📅 2026-09-04 - Painless declarative E2E automation for mobile.
* [Detox](https://github.com/wix/Detox) ⭐ 12,022 | 🐛 206 | 🌐 JavaScript | 📅 2026-09-04 - Gray-box end-to-end testing and automation framework.
* [React Native Testing Library](https://github.com/callstack/react-native-testing-library) ⭐ 3,417 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-04 - Testing utilities that encourage good practices.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,696 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-04 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,925 | 🐛 190 | 🌐 C++ | 📅 2026-09-04 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.

## Starters & Boilerplates

* [Ignite](https://github.com/infinitered/ignite) ⭐ 19,937 | 🐛 34 | 🌐 TypeScript | 📅 2026-06-07 - Infinite Red's battle-tested boilerplate with CLI and generators.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,240 | 🐛 646 | 🌐 TypeScript | 📅 2026-09-04 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,264 | 🐛 2,382 | 🌐 TypeScript | 📅 2026-09-05 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,017 | 🐛 2,188 | 🌐 TypeScript | 📅 2026-09-05 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,773 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-05 - The art world in your pocket.
* [Mattermost](https://github.com/mattermost/mattermost-mobile) ⭐ 2,716 | 🐛 331 | 🌐 TypeScript | 📅 2026-09-05 - Mattermost's mobile apps.
...
Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-react-native/graphs/contributors) ⭐ 35,695 | 🐛 16 | 📅 2026-08-26 :)
