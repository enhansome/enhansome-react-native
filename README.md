...
* [Upgrade Helper](https://github.com/react-native-community/upgrade-helper) ⭐ 4,064 | 🐛 17 | 🌐 TypeScript | 📅 2026-07-23 - Web tool that shows the exact diff between two React Native versions for painless upgrades.
...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 172,506 | 🐛 1,189 | 🌐 Python | 📅 2026-08-21 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,482 | 🐛 62 | 🌐 Shell | 📅 2026-08-28 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,200 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-26 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,151 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13 - MCP server for driving the iOS simulator: interact with UI, take screenshots, inspect the view hierarchy.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,492 | 🐛 1,698 | 🌐 TypeScript | 📅 2026-08-30 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
...
* [react-native-fast-tflite](https://github.com/mrousavy/react-native-fast-tflite) ⭐ 1,230 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-28 - High-performance TensorFlow Lite inference with GPU acceleration.
...
* [React Native Elements](https://github.com/react-native-elements/react-native-elements) ⭐ 25,864 | 🐛 156 | 🌐 MDX | 📅 2026-05-21 - Cross-platform UI toolkit with themed, composable components.
...
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,163 | 🐛 106 | 🌐 TypeScript | 📅 2026-08-30 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [react-native-svg](https://github.com/software-mansion/react-native-svg) ⭐ 8,003 | 🐛 237 | 🌐 TypeScript | 📅 2026-08-20 - SVG rendering for React Native and web.
...
* [gluestack-ui](https://github.com/gluestack/gluestack-ui) ⭐ 5,276 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-26 - Copy-paste components and patterns built on Tailwind-style utility classes.
...
* [react-native-pager-view](https://github.com/callstack/react-native-pager-view) ⭐ 3,355 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-15 - Native ViewPager and UIPageViewController wrapper.
...
* [React Navigation](https://github.com/react-navigation/react-navigation) ⭐ 24,501 | 🐛 844 | 🌐 TypeScript | 📅 2026-08-26 - The standard routing and navigation library for React Native.
...
* [react-native-bottom-sheet](https://github.com/gorhom/react-native-bottom-sheet) ⭐ 9,080 | 🐛 86 | 🌐 TypeScript | 📅 2026-05-09 - Performant, interactive bottom sheet with configurable gestures.
...
* [React Hook Form](https://github.com/react-hook-form/react-hook-form) ⭐ 44,843 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-30 - Performant form state management and validation for React and React Native.
* [Formik](https://github.com/jaredpalmer/formik) ⭐ 34,328 | 🐛 839 | 🌐 TypeScript | 📅 2025-11-10 - Build forms without the tears.
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,705 | 🐛 122 | 🌐 TypeScript | 📅 2026-08-17 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,586 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-29 - Powerful, high-performance camera library with frame processors.
...
* [react-native-audio-api](https://github.com/software-mansion/react-native-audio-api) ⭐ 832 | 🐛 31 | 🌐 C++ | 📅 2026-08-28 - High-performance audio engine implementing the Web Audio API.
...
* [react-native-background-geolocation](https://github.com/transistorsoft/react-native-background-geolocation) ⭐ 2,920 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-14 - Battery-conscious background location with motion detection.
* [rnmapbox/maps](https://github.com/rnmapbox/maps) ⭐ 2,906 | 🐛 157 | 🌐 Kotlin | 📅 2026-07-22 - Mapbox maps for custom map experiences.
...
* [react-native-graph](https://github.com/margelo/react-native-graph) ⭐ 2,608 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-24 - Beautiful, high-performance line graphs built with Skia.
...
* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,972 | 🐛 323 | 🌐 TypeScript | 📅 2026-08-28 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,533 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-23 - High-performance 2D graphics with the Skia rendering engine.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,136 | 🐛 247 | 🌐 TypeScript | 📅 2026-08-29 - Type-safe WebGPU toolkit for advanced GPU work.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,068 | 🐛 67 | 🌐 TypeScript | 📅 2026-07-17 - Tailwind CSS for React Native.
...
* [react-native-safe-area-context](https://github.com/AppAndFlow/react-native-safe-area-context) ⭐ 2,755 | 🐛 119 | 🌐 TypeScript | 📅 2026-08-27 - Flexible safe area inset handling.
...
* [react-native-device-info](https://github.com/react-native-device-info/react-native-device-info) ⭐ 6,681 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-30 - Device information for iOS and Android.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-30 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-web](https://github.com/necolas/react-native-web) ⭐ 22,143 | 🐛 162 | 🌐 JavaScript | 📅 2025-10-16 - Run React Native components and APIs on the web.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,330 | 🐛 798 | 🌐 C++ | 📅 2026-08-28 - Build native Windows apps with React.
...
* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,630 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-28 - Bear necessities for state management.
...
* [Legend State](https://github.com/LegendApp/legend-state) ⭐ 4,193 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-11 - Super fast state with fine-grained reactivity and built-in sync.

### Storage & Databases

* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,627 | 🐛 1,998 | 🌐 TypeScript | 📅 2026-08-28 - TypeScript ORM with first-class Expo/React Native SQLite support.
...
* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,230 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-30 - Powerful async state management and data fetching.
...
* [react-native-netinfo](https://github.com/react-native-netinfo/react-native-netinfo) ⭐ 2,181 | 🐛 173 | 🌐 TypeScript | 📅 2026-02-15 - Network state and connectivity info.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,302 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-30 - Well-tested, feature-rich modular Firebase implementation.
...
* [react-native-purchases](https://github.com/RevenueCat/react-native-purchases) ⭐ 1,205 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-28 - RevenueCat SDK for in-app purchases and subscriptions.
...
* [Reactotron](https://github.com/infinitered/reactotron) ⭐ 15,587 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-13 - Desktop app for inspecting React Native apps: state, API requests, performance.
* [Buoy](https://github.com/Buoy-gg/buoy) ⭐ 690 | 🐛 4 | 📅 2026-08-29 - Devtools that live in your app — and answer to your AI agent.

### Testing

* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,454 | 🐛 496 | 🌐 Kotlin | 📅 2026-08-28 - Painless declarative E2E automation for mobile.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,688 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,920 | 🐛 161 | 🌐 C++ | 📅 2026-08-29 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,159 | 🐛 623 | 🌐 TypeScript | 📅 2026-08-29 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,255 | 🐛 2,396 | 🌐 TypeScript | 📅 2026-08-28 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,015 | 🐛 2,175 | 🌐 TypeScript | 📅 2026-08-29 - New Expensify: financial collaboration, chat-centered.
...
* [Rocket.Chat](https://github.com/RocketChat/Rocket.Chat.ReactNative) ⭐ 2,412 | 🐛 478 | 🌐 TypeScript | 📅 2026-08-28 - Rocket.Chat's mobile client.
