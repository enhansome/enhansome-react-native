...
* [Expo Examples](https://github.com/expo/examples) ⭐ 3,726 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-03 - Example projects demonstrating Expo APIs and integrations.
...
* [Agent Skills](https://github.com/anthropics/skills) ⭐ 176,356 | 🐛 1,234 | 🌐 Python | 📅 2026-09-10 - Anthropic's public repository of agent skills, usable with Claude Code and other agents.
* [Expo Skills](https://github.com/expo/skills) ⭐ 2,531 | 🐛 67 | 🌐 Shell | 📅 2026-09-14 - Agent skills that give coding agents Expo-specific knowledge and best practices.
...
* [mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,693 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-13 - MCP server for mobile automation on iOS, Android, emulators, simulators, and real devices.
...
* [AI SDK](https://github.com/vercel/ai) ⭐ 26,745 | 🐛 1,481 | 🌐 TypeScript | 📅 2026-09-15 - The AI toolkit for TypeScript; works in Expo and React Native apps for chat, streaming, and tool use.
* [react-native-executorch](https://github.com/software-mansion/react-native-executorch) ⭐ 1,737 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-13 - Declarative on-device AI inference powered by ExecuTorch, from Software Mansion.
...
* [llama.rn](https://github.com/mybigday/llama.rn) ⭐ 1,039 | 🐛 19 | 🌐 C | 📅 2026-09-15 - React Native binding of llama.cpp for running LLMs on device.
...
* [React Native Elements](https://github.com/react-native-elements/react-native-elements) ⭐ 25,861 | 🐛 158 | 🌐 MDX | 📅 2026-05-21 - Cross-platform UI toolkit with themed, composable components.
...
* [react-native-paper](https://github.com/callstack/react-native-paper) ⭐ 14,461 | 🐛 494 | 🌐 TypeScript | 📅 2026-09-14 - Material Design components for Android and iOS.
* [Tamagui](https://github.com/tamagui/tamagui) ⭐ 14,188 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-15 - Universal UI kit and style system with an optimizing compiler, 100% parity between React Native and web.
...
* [react-native-calendars](https://github.com/wix/react-native-calendars) ⭐ 10,308 | 🐛 149 | 🌐 TypeScript | 📅 2026-04-23 - Feature-rich calendar components.
...
* [FlashList](https://github.com/Shopify/flash-list) ⭐ 7,233 | 🐛 201 | 🌐 TypeScript | 📅 2026-09-07 - Shopify's fast and performant list, a drop-in replacement for FlatList.
...
* [Legend List](https://github.com/LegendApp/legend-list) ⭐ 3,385 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-11 - High-performance list in pure JS, built for the New Architecture.

### Navigation

* [React Navigation](https://github.com/react-navigation/react-navigation) ⭐ 24,502 | 🐛 845 | 🌐 TypeScript | 📅 2026-09-14 - The standard routing and navigation library for React Native.
...
* [react-native-screens](https://github.com/software-mansion/react-native-screens) ⭐ 3,729 | 🐛 294 | 🌐 TypeScript | 📅 2026-09-14 - Native navigation primitives that back React Navigation's native stack.
...
* [react-native-bottom-sheet](https://github.com/gorhom/react-native-bottom-sheet) ⭐ 9,086 | 🐛 82 | 🌐 TypeScript | 📅 2026-05-09 - Performant, interactive bottom sheet with configurable gestures.
...
* [react-native-true-sheet](https://github.com/lodev09/react-native-true-sheet) ⭐ 2,058 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 - The true native bottom sheet experience.
...
* [react-native-keyboard-controller](https://github.com/kirillzyusko/react-native-keyboard-controller) ⭐ 3,719 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-11 - Keyboard manager that works identically on iOS and Android.
...
* [react-native-vision-camera](https://github.com/mrousavy/react-native-vision-camera) ⭐ 9,623 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-14 - Powerful, high-performance camera library with frame processors.
...
* [react-native-camera-kit](https://github.com/teslamotors/react-native-camera-kit) ⭐ 2,706 | 🐛 108 | 🌐 Swift | 📅 2026-08-03 - High-performance camera library with barcode scanning, by Tesla.
...
* [react-native-audio-api](https://github.com/software-mansion/react-native-audio-api) ⭐ 838 | 🐛 39 | 🌐 C++ | 📅 2026-09-14 - High-performance audio engine implementing the Web Audio API.
* [expo-video](https://docs.expo.dev/versions/latest/sdk/video/) - Modern video playback built for Expo and the New Architecture.

### Maps & Location

* [react-native-maps](https://github.com/react-native-maps/react-native-maps) ⭐ 15,995 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-13 - MapView components for iOS and Android.
* [react-native-background-geolocation](https://github.com/transistorsoft/react-native-background-geolocation) ⭐ 2,925 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-07 - Battery-conscious background location with motion detection.
...
* [react-native-reanimated](https://github.com/software-mansion/react-native-reanimated) ⭐ 10,994 | 🐛 350 | 🌐 TypeScript | 📅 2026-09-15 - The standard for performant animations, running on the UI thread.
...
* [react-native-skia](https://github.com/Shopify/react-native-skia) ⭐ 8,586 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-15 - High-performance 2D graphics with the Skia rendering engine.
* [react-native-gesture-handler](https://github.com/software-mansion/react-native-gesture-handler) ⭐ 6,783 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14 - Declarative, native-driven gesture system.
...
* [TypeGPU](https://github.com/software-mansion/TypeGPU) ⭐ 3,193 | 🐛 280 | 🌐 TypeScript | 📅 2026-09-14 - Type-safe WebGPU toolkit for advanced GPU work.

### Styling & Design Systems

* [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,103 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-11 - CSS-in-JS styling that also targets React Native.
...
* [NativeWind](https://github.com/nativewind/nativewind) ⭐ 8,090 | 🐛 57 | 🌐 JavaScript | 📅 2026-09-15 - Tailwind CSS for React Native.
...
* [react-native-localize](https://github.com/zoontek/react-native-localize) ⭐ 2,441 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-14 - Toolbox for app localization: locales, timezones, currencies.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,306 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-14 - Includes FCM messaging alongside the full Firebase suite.
...
* [react-native-windows](https://github.com/microsoft/react-native-windows) ⭐ 17,342 | 🐛 805 | 🌐 C++ | 📅 2026-09-14 - Build native Windows apps with React.
...
* [Zustand](https://github.com/pmndrs/zustand) ⭐ 58,685 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-14 - Bear necessities for state management.
* [Jotai](https://github.com/pmndrs/jotai) ⭐ 21,265 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 - Primitive and flexible atomic state.
...
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 35,772 | 🐛 2,025 | 🌐 TypeScript | 📅 2026-09-15 - TypeScript ORM with first-class Expo/React Native SQLite support.
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,378 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-15 - Local-first, reactive database that replicates with your backend.
...
* [react-native-mmkv](https://github.com/mrousavy/react-native-mmkv) ⭐ 8,501 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14 - The fastest key/value storage for React Native, \~30x faster than AsyncStorage.
...
* [op-sqlite](https://github.com/OP-Engineering/op-sqlite) ⭐ 1,035 | 🐛 9 | 🌐 C | 📅 2026-09-07 - The fastest SQLite library for React Native.
* [expo-sqlite](https://docs.expo.dev/versions/latest/sdk/sqlite/) - SQLite database access in Expo, with support for Drizzle ORM.

### Networking

* [TanStack Query](https://github.com/TanStack/query) ⭐ 50,297 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-14 - Powerful async state management and data fetching.
...
* [react-native-firebase](https://github.com/invertase/react-native-firebase) ⭐ 12,306 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-14 - Well-tested, feature-rich modular Firebase implementation.
...
* [sentry-react-native](https://github.com/getsentry/sentry-react-native) ⭐ 1,824 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-14 - Official Sentry SDK for crash reporting and performance monitoring.

## Payments & Monetization

* [stripe-react-native](https://github.com/stripe/stripe-react-native) ⭐ 1,428 | 🐛 219 | 🌐 TypeScript | 📅 2026-09-14 - Official Stripe SDK for payments in React Native.
* [react-native-purchases](https://github.com/RevenueCat/react-native-purchases) ⭐ 1,210 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-14 - RevenueCat SDK for in-app purchases and subscriptions.
...
* [EAS CLI](https://github.com/expo/eas-cli) ⭐ 1,355 | 🐛 469 | 🌐 TypeScript | 📅 2026-09-15 - Build, submit, and update iOS and Android apps from the command line.
...
* [Maestro](https://github.com/mobile-dev-inc/Maestro) ⭐ 15,622 | 🐛 515 | 🌐 Kotlin | 📅 2026-09-14 - Painless declarative E2E automation for mobile.
* [Detox](https://github.com/wix/Detox) ⭐ 12,025 | 🐛 209 | 🌐 JavaScript | 📅 2026-09-07 - Gray-box end-to-end testing and automation framework.
...
* [hot-updater](https://github.com/gronxb/hot-updater) ⭐ 1,711 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-15 - Self-hostable OTA update solution, a CodePush alternative.
...
* [Nitro Modules](https://github.com/mrousavy/nitro) ⭐ 1,940 | 🐛 204 | 🌐 C++ | 📅 2026-09-14 - Insanely fast native C++, Swift, or Kotlin modules with statically compiled bindings.

## Starters & Boilerplates

* [Ignite](https://github.com/infinitered/ignite) ⭐ 19,941 | 🐛 38 | 🌐 TypeScript | 📅 2026-06-07 - Infinite Red's battle-tested boilerplate with CLI and generators.
...
* [Joplin](https://github.com/laurent22/joplin) ⭐ 56,369 | 🐛 634 | 🌐 TypeScript | 📅 2026-09-14 - Privacy-focused note-taking app with sync, on every platform.
* [Bluesky](https://github.com/bluesky-social/social-app) ⭐ 18,290 | 🐛 2,412 | 🌐 TypeScript | 📅 2026-09-15 - The Bluesky social app for web, iOS, and Android.
* [Expensify](https://github.com/Expensify/App) ⭐ 5,023 | 🐛 2,300 | 🌐 TypeScript | 📅 2026-09-15 - New Expensify: financial collaboration, chat-centered.
* [Artsy](https://github.com/artsy/eigen) ⭐ 3,774 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-15 - The art world in your pocket.
* [Mattermost](https://github.com/mattermost/mattermost-mobile) ⭐ 2,723 | 🐛 331 | 🌐 TypeScript | 📅 2026-09-15 - Mattermost's mobile apps.
* [Rocket.Chat](https://github.com/RocketChat/Rocket.Chat.ReactNative) ⭐ 2,412 | 🐛 477 | 🌐 TypeScript | 📅 2026-09-15 - Rocket.Chat's mobile client.
...
Many thanks to everyone on the [contributor list](https://github.com/jondot/awesome-react-native/graphs/contributors) ⭐ 35,698 | 🐛 20 | 📅 2026-08-26 :)
